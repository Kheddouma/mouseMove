...
vertex3d.prototype = {
	...
	var textSet = [
		{text:"LEILA", sphereRadius:140, sphereSpace:80, unitTime:100, time:1000},
		{text:"KHEDDOUMA", sphereRadius:120, sphereSpace:70, unitTime:120, time:4000},
		{text:"KHEDDOUMA", sphereRadius:120, sphereSpace:70, unitTime:50, time:2000},
	...
	var start = function() {
		...
		setInterval(function() {
			...
			if(invertCV.execution() > 0.7) {
				strokeColor = "rgba(55, 25, 221, 0.1)";/**bleu */
				backgroundColor = "rgb(190, 153, 49)";/**body jaune */
			} else {
				strokeColor = "rgba(61, 213, 240, 0.1)";/**bleu clair */
				backgroundColor = "rgb(146, 34, 34)";/**body  rouge*/
			};
